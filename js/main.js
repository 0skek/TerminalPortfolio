...
function enterKey(e) {
  if (e.keyCode == 13) {
    ...
    git = commands.length;
    addLine(
      'localHost@skeks.dev:~$ <span class="command">"'+
        command.innerHTML +
        '</span>',
      'liner no-animation',
      0
...
function commander(cmd) {
  switch (cmd) {
    ...
    case 'linkedin':
      ...
      addLine('In case of adblocker or other issues, <a href="https://www.linkedin.com/in/kuntalkek/" target="_blank" style="color: cyan;">click here to redirect to LinkedIn</a>', 'color2', 0);
      newTab(linkedin);
      break;
    case 'github':
      addLine('Opening GitHub...', 'color2', 0);
      addLine('In case of adblocker or other issues, <a href="https://github.com/0skek" target="_blank" style="color: cyan;">click here to redirect to Github</a>', 'color2', 0);
      newTab(github);
      break;
    case 'instagram':
      addLine('Opening Instagram  . . . .', 'color2', 0);
      addLine('In case of adblocker or other issues, <a href="https://www.instagram.com/_skeks/" target="_blank" style="color: cyan;">click here to redirect to Instagram</a>', 'color2', 0);
      newTab(instagram);
      break;
    case 'sudo':
      addLine('Error: You’re not the chosen one, admin powers denied! ', 'color2', 180); 
    ...
    case 'weather':
      ...
      break;
    case 'pwd':
      addLine('skeks/terminal', 'color3', 0);
      break;
    default:
      addLine(
...
function switchTheme(cmd) {
  ...
  loopLines(
    [
      `${themeTxt} not found. Try 'theme ls' to see the list of available themes.`,
    ],
    'color margin',
    80
  );
